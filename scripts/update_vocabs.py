...
BASE_DB_URI = "http://vocprez-fuseki.surroundaustralia.com/gsrsd-vocabs"
WEBSITE_URL = "http://gsrsd.surroundaustralia.com"
...
def get_graph_uri_for_vocab(vocab: Path) -> URIRef:
    ...
    have one and only one ConceptScheme per file and that the GSRSD VocPrez installation uses the ConceptScheme URI
    as the Graph URI"""
...
if __name__ == "__main__":
    ...
    # add_vocabs(
    #     [
    #         Path(__file__).parent.parent / "vocabularies" / "petroleum-tenement-status.ttl",
    #     ], index
    # )
